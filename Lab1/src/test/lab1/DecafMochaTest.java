...
public class DecafMochaTest {
    ...
    public void testSizeCost(){
        ...
        Assert.assertEquals(1.4,decafMocha.cost(),0);
        decafMocha.setSize("medium");
        Assert.assertEquals(1.7,decafMocha.cost(),0);
        decafMocha.setSize("large");
        Assert.assertEquals(2,decafMocha.cost(),0);
        decafMocha.setSize("grant");
        Assert.assertEquals(2.3,decafMocha.cost(),0);
    }
